  ...
  return (
    <LinearGradient colors={['#0A0A0F', '#0D0D1A', '#0A0A0F']} style={s.container}>
      <SafeAreaView style={s.safe}>
        ...
        {/* Skip button — visible dès l'ouverture, hors ScrollView — Apple Guideline 3.1.1 */}
        <TouchableOpacity
        ...
        >
          <Text style={s.skipOverlayText}>{t('paywall.skip')}</Text>
        </TouchableOpacity>
...
const s = StyleSheet.create({
  container: { flex: 1 },
  safe: { flex: 1 },
  scroll: { paddingHorizontal: 24, paddingTop: 20, paddingBottom: 40, maxWidth: 600, alignSelf: 'center', width: '100%' },
  ...
  skipOverlay: { position: 'absolute', top: 12, right: 16, zIndex: 10, paddingVertical: 8, paddingHorizontal: 12 },
  skipOverlayText: { color: '#888899', fontSize: 13, fontWeight: '500' },
